...
export const items = pgTable("items", {
    ...
    elder: boolean("elder").notNull(),
    shaper: boolean("shaper").notNull(),
    searing: boolean("searing").notNull(),
    tangled: boolean("tangled").notNull(),
    memoryItem: boolean("memory_item").notNull(),
    abyssJewel: boolean("abyss_jewel").notNull(),
    delve: boolean("delve").notNull(),
    fractured: boolean("fractured").notNull(),
    synthesised: boolean("synthesised").notNull(),
    ...
    lockedToCharacter: boolean("locked_to_character").notNull(),
    lockedToAccount: boolean("locked_to_account").notNull(),
    duplicated: boolean("duplicated").notNull(),
    split: boolean("split").notNull(),
    corrupted: boolean("corrupted").notNull(),
    unmodifiable: boolean("unmodifiable").notNull(),
    cisRaceReward: boolean("cis_race_reward").notNull(),
    seaRaceReward: boolean("sea_race_reward").notNull(),
    thRaceReward: boolean("th_race_reward").notNull(),
    ...
    isRelic: boolean("is_relic").notNull(),
    foilVariation: integer("foil_variation"),
    replica: boolean("replica").notNull(),
    foreseeing: boolean("foreseeing").notNull(),
    ruthless: boolean("ruthless").notNull(),
...
export const crucibleNodes = pgTable("crucible_nodes", {
    ...
    tier: integer("tier"),
    icon: varchar("icon"),
    allocated: boolean("allocated").notNull(),
    isNotable: boolean("is_notable").notNull(),
...
export const leagues = pgTable("leagues", {
    ...
    category_current: boolean("category_current").notNull(),
    registerAt: varchar("register_at"),
    event: boolean("event").notNull(),
    url: varchar("url"),
    startAt: varchar("start_at"),
    endAt: varchar("end_at"),
    timedEvent: boolean("timed_event").notNull(),
    scoreEvent: boolean("score_event").notNull(),
    delveEvent: boolean("delve_event").notNull(),
    ancestorEvent: boolean("ancestor_event").notNull(),
    leagueEvent: boolean("league_event").notNull(),
});
